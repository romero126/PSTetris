@{
    ...
    Author            = 'juanromer'
    CompanyName       = 'juanromer'
    Copyright         = '(c) juanromer. All rights reserved.'
    ...
    PrivateData = @{
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/juanromer/PSTetris/blob/master/LICENSE'
            ProjectUri   = 'https://github.com/juanromer/PSTetris'
